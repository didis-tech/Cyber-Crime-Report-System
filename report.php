...
<body>
  ...
  <header id="header" class="fixed-top " style="background:#000">
    <div class="container d-flex align-items-center justify-content-between">
      ...
      <h1 class="logo"><a href="index.html">Cyber Security</a></h1>
        ...
        <div class="row gy-4">
          ...
          <div class="col-lg-12">
            <div class="portfolio-info">
              <h3>Information</h3>
              <form action="resources/report.php" method="post">
                <?php require "forms/firstForm.php"; ?>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            Nsukka<br>
              Nigeria <br><br>
              <strong>Phone:</strong> +234 813 443 7849<br>
              <strong>Email:</strong> info@cybersecurity.com<br>
            </p>
          </div>
